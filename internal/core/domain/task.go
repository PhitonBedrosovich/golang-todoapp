...
import (
	...
	core_errors "github.com/PhitonBedrosovich/golang-todoapp/internal/core/errors"
)
...
func (t *Task) Validate() error {
	...
	// провели валидацию, если задача была выполнена
	if t.Completed {
	...
	// никаких ошибок во время валидации не произошло
	return nil
}
...
func (t *Task) ApplyPatch(patch TaskPatch) error {
	...
	if patch.Completed.Set {
		tmp.Completed = *patch.Completed.Value // разименуем так как хотим получить в completed не указатель на bool, а само булевское значение
