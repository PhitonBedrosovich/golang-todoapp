...
type CreateTaskRequest struct {
	...
	Description  *string `json:"description" validate:"omitempty,min=1,max=1000"    example:"Сделать домашнее задание до четверга по математике"`
