...
const docTemplate = `{
        ...
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Начало промежутка рассмотрения статистики (влючительно), формат: YYYY-MM-DD",
                        "name": "from",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_PhitonBedrosovich_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/users": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Размер страницы с пользоваетелями",
                        "name": "limit",
                        "in": "query"
                    },
                    {
        ...
        "/users/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID получаемого пользоветеля",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Пользоваетель успешно найден",
                        "schema": {
    ...
    "definitions": {
        "github_com_PhitonBedrosovich_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.CreateTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    ...
                    "maxLength": 1000,
                    "minLength": 1,
                    "example": "Сделать домашнее задание до четверга по математике"
                },
                "title": {
                    "type": "string",
                    "maxLength": 100,
